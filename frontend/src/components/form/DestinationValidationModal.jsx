              ...
              <div className="relative group p-4 sm:p-5 rounded-2xl bg-surface-inner hover:bg-surface-hover border border-indigo-500/40 hover:border-indigo-500 transition-all duration-200 shadow-md">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className="w-full min-h-[44px] sm:min-h-0 sm:w-auto px-5 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-sky-500 hover:from-indigo-500 hover:to-sky-400 text-white text-xs sm:text-sm font-bold shadow-lg flex items-center justify-center gap-2 transition-all cursor-pointer flex-shrink-0 glow-effect"
                  >
