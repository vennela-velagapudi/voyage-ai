      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-300 text-xs sm:text-sm font-bold uppercase tracking-wide mb-6 shadow-inner"
          >
        ...
        >
          ...
          <section className="space-y-3 pt-6 border-t border-slate-900">
            ...
            <p className="text-slate-400 font-normal mt-2">
