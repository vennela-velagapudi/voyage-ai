    ...
    <div className="relative overflow-hidden pt-12 pb-28 min-h-screen flex items-center justify-center">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-6">
        ...
        <motion.div
          ...
          className="rounded-3xl glass-effect border border-indigo-500/40 p-8 sm:p-14 shadow-2xl relative overflow-hidden bg-gradient-to-b from-slate-900/90 via-slate-950/95 to-slate-950 text-center backdrop-blur-2xl"
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-300 text-xs sm:text-sm font-bold tracking-wide mb-8 shadow-inner"
          >
          ...
          <h1 className="text-3xl sm:text-5xl font-display font-black text-white tracking-tight leading-tight mb-6">
          ...
          <p className="text-base sm:text-xl text-slate-300 max-w-2xl mx-auto mb-12 font-medium leading-relaxed">
            Payment plans and premium features will be introduced in a future release.
          </p>

          {/* Feature Highlights Card Box within Banner */}
          <div className="bg-slate-900/50 border border-slate-800/80 rounded-2xl p-6 sm:p-8 text-left mb-10 shadow-inner max-w-2xl mx-auto">
