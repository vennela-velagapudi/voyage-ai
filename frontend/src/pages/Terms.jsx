      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-border-theme bg-surface-card text-text-body text-xs sm:text-sm font-semibold mb-6 shadow-inner"
          >
          ...
          >
            ...
            <span className="bg-gradient-to-r from-indigo-600 via-sky-600 to-indigo-600 dark:from-indigo-400 dark:via-sky-400 dark:to-indigo-300 bg-clip-text text-transparent">
              Beta Conditions
            </span>
          </motion.h1>
        ...
        >
          ...
          <section className="space-y-3 pt-6 border-t border-border-theme">
            ...
            <ul className="list-disc list-inside space-y-2 text-text-muted pt-2 text-sm pl-2">
              <li>
