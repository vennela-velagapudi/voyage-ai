      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-indigo-300 text-xs sm:text-sm font-semibold tracking-wide mb-6 shadow-inner"
          >
            <Compass
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl font-display font-black text-white tracking-tight mb-6 leading-tight"
          >
        ...
        <div className="space-y-10">
          <motion.div
            ...
            className="p-8 sm:p-10 rounded-3xl glass-effect border border-slate-800/80 bg-slate-950/80 shadow-xl"
          >
            <div className="w-12 h-12 rounded-2xl bg-indigo-500/15 border border-indigo-500/30 text-indigo-400 flex items-center justify-center mb-6 shadow-inner">
          ...
          >
            <div className="p-8 rounded-3xl glass-effect border border-slate-800/80 bg-slate-950/80 flex flex-col justify-between shadow-xl">
              <div>
                <div className="w-12 h-12 rounded-2xl bg-sky-500/15 border border-sky-500/30 text-sky-400 flex items-center justify-center mb-6 shadow-inner">
              ...
              <div className="mt-6 pt-4 border-t border-slate-900 text-xs font-semibold text-slate-500 flex items-center gap-1.5">
            ...
            <div className="p-8 rounded-3xl glass-effect border border-slate-800/80 bg-slate-950/80 flex flex-col justify-between shadow-xl">
              <div>
                <div className="w-12 h-12 rounded-2xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 flex items-center justify-center mb-6 shadow-inner">
